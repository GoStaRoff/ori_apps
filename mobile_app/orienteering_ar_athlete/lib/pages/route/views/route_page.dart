...
import 'package:orienteering_ar_athlete/pages/route/views/comments_page.dart';
import 'package:orienteering_ar_athlete/pages/route/views/passes_page.dart';
                            ...
                            Positioned(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  ...
                                  mainController.currentRoute["cps"] = Rx<List>(
                                      mainController.currentRoute["cps"]);
                                  for (var i = 0;
                                      i <
                                          mainController
                                              .currentRoute["cps"].value.length;
                                      i++) {
                                    (mainController
                                            .currentRoute["cps"].value)[i]
                                        ["is_active"] = Rx<bool>(true);
                                  }
                                  if (mainController
                                          .currentRoute["route_type"] ==
                                      "Detective") {
                                    mainController.currentRoute["next_cp"] =
                                        new Rx<String>(
                                            route["cps"].value[0]["name"]);
                                    mainController.currentRoute["history"] =
                                        Rx<List>([
                                      new Map<String, dynamic>.from(
                                          route["cps"].value[0])
                                        ..addAll({'answer': Rx<String>("")})
                                    ]);
                                  } else {
                                    mainController.currentRoute["next_cp"] =
                                        "".obs;
                                  ...
                                  if (mainController
                                    ...
                                    for (var i = 0;
                                        i <
                                            mainController
                                                .currentRoute["transitions"]
                                                .length;
                                        i++) {
                                      mainController.currentRoute["transitions"]
                                              [i]["show_info"] =
                                          Rx<String>(mainController
                                                  .currentRoute["transitions"]
                                              [i]["show_info"]);
                                    }
                                  } else {
