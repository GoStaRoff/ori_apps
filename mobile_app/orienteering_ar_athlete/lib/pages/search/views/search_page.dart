...
import 'package:orienteering_ar_athlete/pages/global_components/custom_list_item.dart';
...
import 'package:orienteering_ar_athlete/pages/search/controllers/search_controller.dart';
            ...
            Obx(
              () => Expanded(
                child: Container(
                  ...
                  child: ListView.builder(
                    physics: BouncingScrollPhysics(),
                    itemCount: searchController.coachs.length,
                    itemBuilder: (_, i) => InkWell(
                      onTap: () {
                        // Get.to(
                        //   RoutePage(
                        //     searchController.coachs[i]["coach_id"],
                        //   ),
                        // );
                      },
                      child: CustomListItem(
                        ...
                        leftChild: Text(
                          searchController.coachs[i]["coach_name"],
                          style: MAIN_TEXT_STYLE_BLACK,
                        ),
                      ),
                    ),
